...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        Consulta consulta1 = new Consulta(1, new DateTime(2023, 06, 01, 10, 23, 24), "Guimarães", new Paciente(PessoaTipo.Paciente, "Vera Lemos", new DateOnly(1965, 02, 15), 125366912, "vera-lemos@gmail.com", 120231303, 1.62, 52, 101, 163, "HTA Grau II", 192, 82));
        ...
        Consulta consulta3 = new Consulta(3, new DateTime(2023, 06, 02, 09, 42, 33), "Braga", new Paciente(PessoaTipo.Paciente, "Carla Mota", new DateOnly(1973, 06, 12), 156315465, "carlamota@gmail.com", 153300145, 1.74, 60, 86, 134, "Normal-Alta (1)", 194, 87));
        ...
        Consulta consulta5 = new Consulta(5, new DateTime(2023, 06, 05, 14, 05, 32), "Guimarães", new Paciente(PessoaTipo.Paciente, "Maria Lima", new DateOnly(1996, 05, 09), 255654662, "malima@gmail.com", 232646464, 1.58, 49, 75, 110, "Óptima", 180, 90));
        Consulta consulta6 = new Consulta(6, new DateTime(2023, 06, 06, 09, 58, 02), "Braga", new Paciente(PessoaTipo.Paciente, "César Antunes", new DateOnly(1943, 08, 29), 112564688, "tunescesar@gmail.com", 123563333, 1.69, 69, 87, 135, "Normal-Alta (1)", 205, 95));
        ...
        Consulta consulta8 = new Consulta(8, new DateTime(2023, 06, 07, 10, 05, 02), "Braga", new Paciente(PessoaTipo.Paciente, "Júlio Seixas", new DateOnly(1978, 10, 23), 564646460, "jules.xas@gmail.com", 135646334, 1.78, 70, 94, 150, "HTA Grau I", 203, 105));
        ...
        Consulta consulta12 = new Consulta(12, new DateTime(2023, 06, 12, 11, 05, 06), "Guimarães", new Paciente(PessoaTipo.Paciente, "Óscar Pacheco", new DateOnly(1953, 02, 22), 135468333, "o_scar@gmail.com", 465433310, 1.84, 77, 103, 165, "HTA Grau II", 206, 97));
            ...
            if (email.Contains("_admin@smd.pt"))
            {
                ...
                do
                {
                    ...
                    else if (op == 3)
                    {
                        ...
                        Console.WriteLine("-----------");
                        //Sub-Menu -> Relatórios
                        Console.WriteLine("1 - Consultas Efectuadas | 2  - Vencimentos | 3 - Equipamentos");
                        Console.Write("Seleccione uma opção: ");
                        ...
                        if (rel == 1)
                        {
                            ...
                            //conta o total de consultas presentes na lista
                            var total = consultas.Count;
                            Console.Write("Total de consultas realizadas: " + total);
                            Console.WriteLine();
                            Console.WriteLine();

                            //vamos agrupar as consultar por dia
                            var tbConsultas = consultas.
                                            GroupBy(c => c.DataConsulta.Date).
                                            Select(cs => new { DataConsulta = cs.Key.Date, Total = cs.Count() });

                            Console.WriteLine();

                            Console.WriteLine("Tabela contagem de consultas por dia:");
                            Console.WriteLine();
                            Console.WriteLine("DIA                 | TOTAL");

                            // e apresentar numa tabela com o total de consultas por dia
                            foreach (var totalPorDia in tbConsultas)
                            {
                                Console.WriteLine($"| {totalPorDia.DataConsulta} | {totalPorDia.Total} |");
                            }
